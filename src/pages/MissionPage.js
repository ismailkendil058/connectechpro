  ...
  return (
    <div className="relative flex size-full min-h-screen flex-col bg-white justify-between group/design-root overflow-x-hidden" style={{ fontFamily: 'Inter, "Noto Sans", sans-serif' }}>
      <div>
        ...
        {/* Mission Content */}
        <h2 className="text-[#131416] tracking-light text-[28px] font-bold leading-tight px-4 text-center pb-3 pt-5">Our Mission</h2>
        <p className="text-[#131416] text-base font-normal leading-normal pb-3 pt-1 px-4 text-center">
          At Youcef Belouz, our mission is to empower individuals and organizations with the knowledge and skills to excel in project management and agile methodologies. We strive
          to provide accessible, high-quality training that fosters innovation, collaboration, and continuous improvement.
        </p>
      </div>
