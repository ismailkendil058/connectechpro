  ...
  return (
    <div className="relative flex size-full min-h-screen flex-col bg-white justify-between group/design-root overflow-x-hidden" style={{ fontFamily: 'Inter, "Noto Sans", sans-serif' }}>
      <div>
        ...
        {/* Vision Content */}
        <h2 className="text-[#131416] tracking-light text-[28px] font-bold leading-tight px-4 text-center pb-3 pt-5">Our Vision</h2>
        <p className="text-[#131416] text-base font-normal leading-normal pb-3 pt-1 px-4 text-center">
          To become the global leader in project management and agile education, transforming how organizations approach learning and development. We envision a world where every professional has access to world-class training that drives innovation and success.
        </p>
        
        <div className="px-4 space-y-4 mt-6">
          <div className="bg-[#f0f2f4] p-4 rounded-lg">
            <h3 className="text-[#131416] text-lg font-bold mb-2">Global Impact</h3>
            <p className="text-[#131416] text-base font-normal leading-normal">
              We aim to reach learners worldwide, breaking down barriers to quality education and creating opportunities for growth across all industries.
            </p>
          </div>
          
          <div className="bg-[#f0f2f4] p-4 rounded-lg">
            <h3 className="text-[#131416] text-lg font-bold mb-2">Technology-Driven Learning</h3>
            <p className="text-[#131416] text-base font-normal leading-normal">
              Leveraging cutting-edge technology to create immersive, interactive learning experiences that adapt to individual needs and learning styles.
            </p>
          </div>
          
          <div className="bg-[#f0f2f4] p-4 rounded-lg">
            <h3 className="text-[#131416] text-lg font-bold mb-2">Community Building</h3>
            <p className="text-[#131416] text-base font-normal leading-normal">
              Fostering a vibrant community of learners, practitioners, and thought leaders who share knowledge and drive industry advancement.
            </p>
          </div>
        </div>
      </div>
